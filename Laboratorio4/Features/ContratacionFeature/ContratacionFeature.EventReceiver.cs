...
namespace Laboratorio4.Features.ContratacionFeature
{
    ...
    { 
        ...
        // PARA GENERAR EL CÓDIGO LARGO HAY QUE CREAR UNA VARIABLE Y ÉL SOLO TE GENERA UN CÓDIGO LARGO POR DEFECTO //
        ...
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            {
                contratacionCT = new SPContentType(ctid, web.ContentTypes, "Contratación");
